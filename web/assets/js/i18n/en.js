// Английский словарь сайта — основной: по нему сверяются остальные языки
// (tests/i18n_check.mjs), и из него берётся текст, если перевода нет.
//
// {x} — подстановка значения. Ключ с окончанием _one — форма для одного
// предмета (tn); в русском словаре есть ещё _few (2–4) и _many (5–20).
...
export default {
  ...
  settings: {
    ...
    language: 'Language',
    auto: 'Automatic ({lang})',
    autoHint: 'Automatic: in a game — the language the host chose for it, elsewhere — your browser\'s language. Your choice is saved in this browser.'
  },
  ...
  notices: {
    ...
    kinds: {
      fine: 'The city fined you {amount}.',
      grant: 'The city gave you a grant of {amount}.',
      city_tax: 'The city charged a tax of {amount}.',
      stake_bought_city: 'You bought {pct} of {inst} from the city for {amount}. Your share of its profit is paid to you every month.',
      stake_buyback: 'The city bought back {pct} of {inst} from you for {amount}.',
      stake_bought: 'You bought {pct} of {inst} from {team} for {amount}.',
      stake_sold: 'You sold {pct} of {inst} to {team} for {amount}.',
      transfer: '{team} sent you {amount}.',
      employment: '{name} offers to work for you as {job} for {salary} a month.',
      credit: 'Your credit limit is now {amount}.',
      bankrupt: 'Your restaurant ran out of cash and closed. Choose what to do next.'
    }
  },
  ...
  // «10% of the landlord» — название компании внутри фразы.
  institutionsOf: {
    landlord: 'the landlord', bank: 'the bank', insurer: 'the insurance company', utility: 'the utility company'
  },
  ...
  ocean: {
    ...
    driver: {
      priceWar: 'Price war in month {n}: the average price was {avg}, below the {ref} reference — every guest earned less for everyone.',
      priceOk: 'No price war in month {n}: the average price was {avg} (reference {ref}).',
      adRace: 'Ad race in month {n}: advertising took {share} of all sales — ads mostly move guests between restaurants.',
      adOk: 'No ad race in month {n}: advertising took {share} of sales.',
      crowded: 'Too crowded in month {n}: {guests} guests for {restaurants} — at a fair price that keeps only about {feeds} profitable.',
      roomy: 'Room to grow in month {n}: {guests} guests for {restaurants} — at a fair price that is enough to keep about {feeds} profitable.',
      feedsHow: 'How it is counted: at {ref} a guest leaves {perGuest} after food, so a restaurant needs about {breakEven} guests a month to cover {fixed} of fixed costs. {guests} ÷ {breakEven} ≈ {feeds}.',
      quality: 'Quality grew the market in month {n}: the town\'s average quality was {quality} out of 3, so {boost} more guests came than with no quality at all — about {extra} extra guests, shared by all restaurants.',
      noQuality: 'No quality in month {n} yet: the town\'s average quality is 0. Every point of average quality brings about {gain} more guests — for every restaurant, not only the one that invested.'
    },
    nRestaurants: '{n} restaurants',
    nRestaurants_one: '{n} restaurant',
    feedsNote: '“Can keep profitable” — how many restaurants that month\'s guests could keep in profit at the reference price: guests ÷ the guests one restaurant needs to cover its fixed costs.',
    ...
    columns: {
      restaurants: 'Restaurants', guests: 'Guests', feeds: 'Can keep profitable', avgPrice: 'Avg price', adShare: 'Ads / sales',
  ...
  host: {
    ...
    rosterWhy: {
      ...
      host: 'the host can\'t play in their own game',
      repeated: 'repeated',
      played: 'already played — removing it would break the game history'
    },
    ...
    confirmStake: {
      sell: 'Sell {pct} of {inst} to {buyer} for {price}?',
      buyback: 'Buy back {pct} of {inst} from {seller} for {price}?',
      deal: '{seller} sells {pct} of {inst} to {buyer} for {price}?'
    },
    ...
    logoWorking: 'Preparing the logo…', logoReady: 'Logo ready — it is saved with the game.',
    logoFileBad: 'We couldn\'t read that file. Use a PNG, JPG, WebP or SVG image.',
    logoChecking: 'Checking the link…', logoOk: 'The link opens as an image.',
    logoBad: 'This link doesn\'t open as an image. Upload the file instead, or use a direct link to a PNG, JPG or SVG file. A Google Drive file must be shared with “Anyone with the link”.',
    logoHint: 'PNG, JPG, WebP or SVG of any size: we trim empty edges and shrink it for the web. A transparent background looks best. Uploading the file is the most reliable way.',
    saved: 'Saved.',
    economy: 'Economy',
    ...
    configWhy: {
      not_editable: 'can\'t be changed',
      not_number: 'not a number',
      not_whole: 'must be a whole number',
      range: 'allowed from {min} to {max}'
    },
  ...
  history: {
    ...
    notes: {
      ...
      month_cash_flow: 'Month {n} result',
      dividends: 'Dividends from your stakes',
      loan_out: 'Loan received',
      loan_repay: 'Early loan repayment',
      loan_repay_closing: 'Loan repaid on closing',
      transfer_to: 'Transfer to {team}',
      transfer_from: 'Transfer from {team}',
      stake_bought_city: 'Bought {pct} of {inst} from the city',
      stake_sold_city: 'Sold {pct} of {inst} to the city',
      stake_bought: 'Bought {pct} of {inst} from {team}',
      stake_sold: 'Sold {pct} of {inst} to {team}',
      unpaid_written_off: 'Unpaid bills written off',
      business_closed: 'Business closed',
      cash_kept: 'Cash kept after closing',
      left_game: 'Left the game',
      new_business: 'New business opened',
      new_business_cash: 'Starting cash of the new business',
      salary_to: 'Salary to {name}',
      salary_from: 'Salary from {team}',
      civil_salary: 'Government job salary',
      civilSalaryMonths: 'Government job salary for {n} months'
    },
    kinds: {
    ...
    s: {
      ...
      ocean: {
        ...
        body: [
          ...
          '- **Too many restaurants.** {marketBase} guests a month keep about {feedsText} profitable at a fair price. More restaurants than that — and everyone loses money.',
          '**What turns it blue**',
  ...
  // Столбцы CSV-выгрузок отчёта.
  csv: {
    month: 'Month', status: 'Status', team: 'Team', inBusiness: 'In business', price: 'Price',
    served: 'Guests served', lost: 'Guests turned away', sharePct: 'Market share %', revenue: 'Revenue',
    cogs: 'Food & supplies', rent: 'Rent', insurance: 'Insurance', utilities: 'Utilities & other', payroll: 'Payroll',
    shifts: 'Extra shifts', qualityUpkeep: 'Quality upkeep', qualityInvest: 'Quality investment',
    advertising: 'Advertising', ebit: 'Operating profit', interest: 'Loan interest', pbt: 'Profit before tax',
    tax: 'Profit tax', profit: 'Net profit', principal: 'Loan principal paid', cashFlow: 'Cash flow',
    dividends: 'Dividends', cashEnd: 'Cash / savings at month end', loanEnd: 'Loan balance at month end',
    capital: 'Capital (cash − loan)', brand: 'Brand', reputation: 'Reputation', quality: 'Quality',
    capacity: 'Capacity', sent: 'Decision sent by team', cash: 'Cash / savings', profitIncome: 'Profit / income',
    repeated: 'Repeated automatically', shiftChange: 'Shift change',
    yes: 'yes', no: 'no', noRepeated: 'no (repeated)'
  },

  // Часовые пояса в форме игры.
  tz: {
    eastern: 'Eastern (New York)', central: 'Central (Chicago)', mountain: 'Mountain (Denver)',
